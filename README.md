...
### 20. [缓存工具](cache_tools/README.md)

- **功能**：提供高性能内存缓存功能，支持LRU淘汰策略、TTL过期时间、JSON序列化等。基于sync.Map实现并发安全的缓存操作，内置大小限制和定时清理机制，提供统一的缓存管理接口。支持字符串和复杂对象缓存，适用于需要临时数据存储和快速访问的应用场景。

### 21. [AI 工具](ai_tools/README.md)
